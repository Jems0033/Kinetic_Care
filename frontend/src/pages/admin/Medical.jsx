          ...
          <div className="medical-record-grid">
            {filteredRecords.length === 0 ? (
              ...
              filteredRecords.map((record) => (
                <div className="medical-record-card" key={record._id}>
                  {/* TOP */}

                  <div className="medical-card-top">
                    <div className="patient-info">
                      <div className="patient-avatar">
                        {record.residentId?.name?.charAt(0)?.toUpperCase() ||
                          "R"}
                      </div>
                      ...
                      <div>
                        ...
                        <h3>{record.residentId?.name || "Unknown Resident"}</h3>
                      </div>
                    </div>
                  ...
                  <div className="health-condition-box">
                    <span className="condition-label">Health Condition</span>

                    <h4>{record.problem || "No problem specified"}</h4>
                  </div>
                  ...
                  <div className="medical-info-grid">
                    <div className="medical-info-item">
                      <div className="info-icon doctor-icon">🩺</div>
                    ...
                    <div className="medical-info-item">
                      <div className="info-icon medicine-icon">💊</div>
